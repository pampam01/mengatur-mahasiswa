@include('templates.form', ['halaman' => 'kelas', 'title' => 'Tambah Kelas'])
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <div class="row row-cards">
                <div class="col-12">
                    <form class="card" method="post" action="{{ route('kelas.tambah.action') }}" autocomplete="off">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="row row-cards">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        @enderror
                                        <input type="text" class="form-control" placeholder="Pagi|Malam X"
                                            name="nama">
                                    </div>
                                </div>
