@include('templates.form', ['halaman' => 'matkul', 'title' => 'Edit matkul'])
            ...
            <div class="row row-cards">
                <div class="col-12">
                    <form class="card" method="post"
                        action="{{ route('matkul.edit.action', ['id' => $dataMatkul->id]) }}" autocomplete="off">
                        @csrf
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="pemrograman"
                                            value="{{ $dataMatkul->nama }}" name="nama">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" placeholder="1"
                                            value="{{ $dataMatkul->semester }}" name="semester">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" placeholder="2024"
                                            value="{{ $dataMatkul->tahun }}" name="tahun">
                                    </div>
                                </div>
                            </div>
                        </div>
