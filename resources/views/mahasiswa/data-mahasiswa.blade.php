@include('templates.header', ['halaman' => 'mahasiswa', 'title' => 'Mahasiswa'])
<div class="page-wrapper">
    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            ...
            @if (Session::has('status-gagal'))
                <div class="alert alert-danger alert-dismissible" role="alert">
                    <div class="d-flex">
                        ...
                        <div>
                            <h4 class="alert-title">Gagal menambahkan data mahasiswa</h4>
            ...
            @endif
            @if (Session::has('status-gagal-edit'))
                <div class="alert alert-danger alert-dismissible" role="alert">
                    <div class="d-flex">
                        <div>
                            <!-- Download SVG icon from http://tabler-icons.io/i/alert-circle -->
                        ...
                        <div>
                            <h4 class="alert-title">Gagal mengedit data mahasiswa</h4>
                            <div class="text-secondary">{{ Session::get('status-gagal-edit') }}</div>
                        </div>
                    </div>
                    <a class="btn-close mt-2" data-bs-dismiss="alert" aria-label="close"></a>
                </div>
            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="{{ route('mahasiswa.tambah.page') }}" class="btn btn-primary d-none d-sm-inline-block"
                        ...
                        <a href="{{ route('mahasiswa.tambah.page') }}" class="btn btn-primary d-sm-none btn-icon"
                                        ...
                                        <tr>
                                            <td class="text-secondary">{{ $loop->iteration }}
                                                @if (Session::has('idDataBaru'))
                                                    ...
                                                    @endif
                                                @endif
                                                @if (Session::has('idMahasiswaTerdaftar'))
                                                    @if (Session::get('idMahasiswaTerdaftar') == $dt->id)
                                                        <span
                                                            class="badge bg-orange text-blue-fg ms-2">Terdaftar</span>
                                                    @endif
                                                @endif
                                            </td>
                                            <td class="text-secondary">{{ $dt->nim }}</td>
                                            ...
                                            <td class="btn-aksi">
                                                <a href="{{ route('mahasiswa.detail.page', ['id' => $dt->id]) }}"
                                            ...
                                            <td class="btn-aksi">
                                                <a href="{{ route('mahasiswa.edit.page', ['id' => $dt->id]) }}"
